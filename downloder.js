...
(function () {
 ...
 var BUTTON_TEXT={'ar':'魔?万??','cs':'St찼hnout','de':'Herunterladen','en':'Download','es':'Descargar','fr':'T챕l챕charger','it':'Scarica','ja':'??╉꺍??꺖??','pl':'Pobierz','pt':'Baixar','ro':'Desc훱rca?i','ru':'鬼克逵?逵??','zh':'訝뗨슬'};
  var BUTTON_TOOLTIP={'ar':'魔?万?? ?莫碼 碼???膜??','cs':'St찼hnout toto video','de':'Dieses Video herunterladen','en':'Download this video','es':'Descargar este v챠deo','fr':'T챕l챕charger cette vid챕o','it':'Scarica questo video','ja':'?볝겗?볝깈?ゃ굮??╉꺍??꺖?됥걲??','pl':'Pobierz plik wideo','pt':'Baixar este v챠deo','ro':'Desc훱rca?i acest videoclip','ru':'鬼克逵?逵?? ??棘 勻龜畇筠棘','zh':'訝뗨슬閭ㅸ쭍窯?'};
...
var youtubeDownloader = "false";
chrome.extension.sendRequest({}, function(response) {
	youtubeDownloader = response.active;
	if(youtubeDownloader == "true") {
		downloader();
	}
});
